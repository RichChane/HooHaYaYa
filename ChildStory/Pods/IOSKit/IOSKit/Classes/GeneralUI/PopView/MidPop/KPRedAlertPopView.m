...
{
    CGFloat itemWidth = _contentWidth-15*2;
    ...
    titleLabel.frame = CGRectMake(15, 25, itemWidth, 25);
    titleLabel.textAlignment = NSTextAlignmentCenter;
    ...
    contentLabel.frame = CGRectMake(15, CGRectGetMaxY(titleLabel.frame)+5, itemWidth, contentHeight) ;
    contentLabel.textAlignment = NSTextAlignmentCenter;
    _contentLabel = contentLabel;
    [_contentView2 addSubview:contentLabel];
    
    KPTextField *dynamicTextField = [[KPTextField alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(contentLabel.frame)+10, itemWidth, 50)];
    ...
    UIButton *dynamicBtn = [[UIButton alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(dynamicTextField.frame), itemWidth, 25)];
