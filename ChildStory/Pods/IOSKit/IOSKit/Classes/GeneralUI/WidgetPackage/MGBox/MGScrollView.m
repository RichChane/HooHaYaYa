...
//        if (box.tag == 20161214) {
//            UIView *view = box.subviews[0].subviews[1].subviews[1];
//            
//            view.frame = CGRectMake(view.LXHX, view.LXHY, SCREEN_WIDTH - 5, view.LXHHeight);
//        }
...
- (void)updateContentSize {
    ...
    if (_isNeedRefresh)
    {
        self.contentSize = CGSizeMake(self.frame.size.width, MAX(height, self.frame.size.height) + 1);//scrollView需要下拉刷新的情况把contentsize加大1个尺寸 使其能滑动
    }
    else
    {
