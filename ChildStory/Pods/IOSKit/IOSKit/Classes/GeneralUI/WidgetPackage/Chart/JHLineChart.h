...
@property (nonatomic, readonly)NSMutableArray * valuePointArray;
// 是否绘制渐变色
@property (nonatomic, assign) BOOL isDrawLinearGradient;
/**
 *  Y 轴 几等份，默认3
 */
@property NSUInteger  yLineCount;

/**
 *  X 轴 几等份，默认5
 */
@property NSUInteger  xLineCount;
...
/**
 *  Drawing path is the curve, the default NO       是否曲线
 */
