...
#import <IOSKit/KeyBoardDigitalView.h>
...
+ (UIButton *)FootSaveButton:(CGRect)bFrame {
    ...
    [saveButton.layer setCornerRadius:GC.cornerRadius];
    [saveButton.layer setMasksToBounds:YES];
    [saveButton setTitle:@"保存" forState:0];
    [saveButton.titleLabel setFont:FontSize(18)];
...
- (void)buildKeyBoard {
    ...
    if (_headView) {
        ...
        frameView.size.height += _headView.size.height;
    }
    ...
    for (int i = 0; i < leftArray.count; i++) {
        ...
        [button.titleLabel setFont:[UIFont fontWithName:@"Avenir-Roman" size:ASIZE(19)]];
    ...
    [GeneralUIUse AddLineDown:_keyMainView Color:GC.LINE LeftOri:0 RightOri:0];
