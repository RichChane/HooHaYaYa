...
@property (strong, nonatomic) DQKSignView *signView;        // 左上角对象
...
// Click Row
- (void)freezeWindowView:(DQKFreezeWindowView *)freezeWindowView didSelectRow:(NSInteger)row;
// Click Section
- (void)freezeWindowView:(DQKFreezeWindowView *)freezeWindowView didSelectSection:(NSInteger)section;
