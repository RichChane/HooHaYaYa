...
- (instancetype)initLogo:(UIImage *)img_arrow_down Logo2:(UIImage *)retake Logo3:(UIImage *)takeok
{
    self = [super init];
    if (self) {
        ...
        [self.dismissBtn setImage:img_arrow_down forState:UIControlStateNormal];
        ...
        [self.cancelBtn setImage:retake forState:UIControlStateNormal];
        ...
        [self.doneBtn setImage:takeok forState:UIControlStateNormal];
...
- (void)setupUI
{
    ...
    self.toolView = [[CameraToolView alloc] initLogo:_photoArrowDown Logo2:_photoRetake Logo3:_photoTakeok];
    ...
    self.focusCursorImageView = [[UIImageView alloc] initWithImage:_photoFocus];
    ...
    [self.toggleCameraBtn setImage:_photoToggleCamera forState:UIControlStateNormal];
