...
@implementation RCMJRefreshHeader
...
- (UILabel *)stateLabel
{
    if (!_stateLabel) {
        ...
        [label setFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, StatusLabelHeight)];
...
- (UILabel *)lastUpdatedTimeLabel
{
    if (!_lastUpdatedTimeLabel) {
        ...
        UILabel *label = [UILabel new];
        label.textAlignment = NSTextAlignmentCenter;
        [label setFrame:CGRectMake(0, StatusLabelHeight, [UIScreen mainScreen].bounds.size.width, StatusLabelHeight)];
        [label setFont:MJRefreshLabelFont];
        [label setTextColor:MJRefreshLabelTextColor];
        [self addSubview:label];
